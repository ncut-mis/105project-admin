...
<div class="row">
    <form action="/back/staff/{{$staff->id}}" method="POST" role="form">
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
        <div class="col-md-12" style="background-color: lightblue">
            ...
            {{--<div class="form-group">--}}
                {{--<label>標題：</label>--}}
                {{--<input name="title" class="form-control" placeholder="請輸入文章標題" value="{{$staff->name}}">--}}
            {{--</div>--}}

            {{--<div class="form-group">--}}
                {{--<label>內容：</label>--}}
                {{--<textarea name="content" class="form-control" rows="10">{{$staff->content}}</textarea>--}}
            {{--</div>--}}

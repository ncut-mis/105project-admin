...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        {{--<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">--}}
            ...
            {{--<span class="icon-bar"></span>--}}
        {{--</button>--}}
        <a class="navbar-brand" href="{{ route('admin.dashboard.index') }}"><font color="#ffffff" face="微軟正黑體">尚食併狂</font></a>
    </div>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li class="active">
                <a href="{{ route('admin.dashboard.index') }}"><font color="#ffffff" face="微軟正黑體"><i class="fa fa-home"></i>　Home</font></a>

                <a href="{{ route('admin.restaurants.index') }}"><font color="#ffffff" face="微軟正黑體"><i class="fa fa-registered"></i>　餐廳帳號管理</font></a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
